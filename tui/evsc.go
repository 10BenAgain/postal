...
func (m *EVSCEditor) CommitEdits() {
	...
	m.pks.Sub2.SpAtkEV = uint8(m.vals[3])
	m.pks.Sub2.SpDefEV = uint8(m.vals[4])
	m.pks.Sub2.SpeEV = uint8(m.vals[5])
...
func (m *EVSCEditor) UpdateValues() {
	...
	m.vals[3] = uint(m.pks.Sub2.SpAtkEV)
	m.vals[4] = uint(m.pks.Sub2.SpDefEV)
	m.vals[5] = uint(m.pks.Sub2.SpeEV)
